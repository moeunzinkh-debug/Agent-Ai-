...
val DarkBgCard = Color(0xFF1E1E2F)
val DarkBgInput = Color(0xFF2A2A3D)
val DarkBgHover = Color(0xFF2E2E45)

val DarkTextPrimary = Color(0xFFE8E8F0)
val DarkTextSecondary = Color(0xFFA0A0B8)
val DarkTextMuted = Color(0xFF6C6C8A)
...
val LightBgInput = Color(0xFFF9FAFB)
val LightBgHover = Color(0xFFE5E7EB)
...
val CodeBlockBg = Color(0xFF12121E)
